...
# EXEC_SOURCES
  ...
  TARGET_LINK_LIBRARIES(${execName} timing ${COMPOSE_LIBRARY_TYPE} ${LAPACK_LIBRARIES} ${BLAS_LIBRARIES})
...
macro(createExecLib libName execType libSrcs inclDirs macroNP
  ...
  TARGET_LINK_LIBRARIES(${libName} PUBLIC timing ${COMPOSE_LIBRARY} ${LAPACK_LIBRARIES} ${BLAS_LIBRARIES})
